...
function FormElement({
  type, handleSubmit, username, password, FirstName, LastName, Email
}) 
{
  // useEffect(() => {
  ...
  return (
    ...
    <div className="form-group">
        ...
        <Input type="email" className="form-control" placeholder="email adresse" value={Email}/>
    </div>
    <br></br>
    <div className="form-group">
    ...
    <br></br>
    <Btn type="submit" className="btn btn-success btn-block">{type}</Btn>
